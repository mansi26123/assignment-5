...
From Api folder, you can run `mongo "mongodb+srv://cluster0.rbcwh.mongodb.net/myFirstDatabase"--username mansi261 change scripts/init.mongo.js` and enter password as `Abc123` to reset the database with two products added initially.
